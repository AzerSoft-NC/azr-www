...
const validLogins = [
    ...
    {names: ['Jannick Wadjahdi', 'Nanoute'], habilitation: MAIRIE + LAIC + SOIREE},
    {names: ['Jacques Wadjahdi', 'Kakounet'], habilitation: MAIRIE + LAIC + SOIREE},
    ...
    {names: ['Olivier Thomas', 'Lara Perazzi'], habilitation: MAIRIE + LAIC + SOIREE},
    ...
    {names: [ 'Fabrice Fort'], habilitation: MAIRIE + LAIC },
    ...
    {names: ['Manu Rolland', 'Emmanuel Rolland'], habilitation: MAIRIE + LAIC + SOIREE},
